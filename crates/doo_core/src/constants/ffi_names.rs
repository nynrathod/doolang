...
// ============================================================================
// Doo DB FFI (doo_ffi_db) — Single Source of Truth
// ============================================================================

/// Library name for doo_ffi_db
pub const LIB_DOO_DB: &str = "doo_db";
/// Raw parameterized query: doo_db_raw_param(db, sql, params_json) -> *DooResult
pub const DOO_DB_RAW_PARAM: &str = "doo_db_raw_param";
/// Raw SQL query (no params): doo_db_raw(db, sql) -> *DooResult
pub const DOO_DB_RAW: &str = "doo_db_raw";

// ============================================================================
// Query Builder — Method Name Constants (Single Source of Truth)
// ============================================================================

/// Terminal methods that conclude a query chain and trigger code emission.
pub const QB_TERMINAL_EXEC: &str = "exec";
pub const QB_TERMINAL_EXEC_ONE: &str = "execOne";
pub const QB_TERMINAL_TO_SQL: &str = "toSql";
pub const QB_TERMINALS: &[&str] = &[QB_TERMINAL_EXEC, QB_TERMINAL_EXEC_ONE, QB_TERMINAL_TO_SQL];

/// Entry methods on Database that begin a query chain.
pub const QB_ENTRY_FIND: &str = "find";
pub const QB_ENTRY_FIND_ONE: &str = "findOne";
pub const QB_ENTRY_COUNT: &str = "count";
pub const QB_ENTRY_INSERT: &str = "insert";
pub const QB_ENTRY_INSERT_MANY: &str = "insertMany";
pub const QB_ENTRY_UPDATE: &str = "update";
pub const QB_ENTRY_DELETE: &str = "delete";
pub const QB_ENTRIES: &[&str] = &[
    QB_ENTRY_FIND,
    QB_ENTRY_FIND_ONE,
    QB_ENTRY_COUNT,
    QB_ENTRY_INSERT,
    QB_ENTRY_INSERT_MANY,
    QB_ENTRY_UPDATE,
    QB_ENTRY_DELETE,
];

/// Chainable filter/modifier methods (non-terminal, non-entry).
pub const QB_CHAIN_WHERE: &str = "where";
pub const QB_CHAIN_OR_WHERE: &str = "orWhere";
pub const QB_CHAIN_WHERE_NOT: &str = "whereNot";
pub const QB_CHAIN_WHERE_IN: &str = "whereIn";
pub const QB_CHAIN_WHERE_NULL: &str = "whereNull";
pub const QB_CHAIN_WHERE_NOT_NULL: &str = "whereNotNull";
pub const QB_CHAIN_WHERE_BETWEEN: &str = "whereBetween";
pub const QB_CHAIN_ORDER_BY: &str = "orderBy";
pub const QB_CHAIN_LIMIT: &str = "limit";
pub const QB_CHAIN_OFFSET: &str = "offset";
pub const QB_CHAIN_SELECT: &str = "select";
pub const QB_CHAIN_EXCLUDE: &str = "exclude";
pub const QB_CHAIN_DISTINCT: &str = "distinct";
pub const QB_CHAIN_GROUP_BY: &str = "groupBy";
pub const QB_CHAIN_HAVING: &str = "having";
pub const QB_CHAIN_AGGREGATE: &str = "aggregate";
pub const QB_CHAIN_SET: &str = "set";
pub const QB_CHAIN_INCREMENT: &str = "increment";
pub const QB_CHAIN_DECREMENT: &str = "decrement";
pub const QB_CHAIN_RETURNING: &str = "returning";

/// Comparison operator function names used inside .where({}) clauses.
pub const QB_OP_GT: &str = "Gt";
pub const QB_OP_GTE: &str = "Gte";
pub const QB_OP_LT: &str = "Lt";
pub const QB_OP_LTE: &str = "Lte";
pub const QB_OP_NE: &str = "Ne";
pub const QB_OP_LIKE: &str = "Like";
pub const QB_OP_ILIKE: &str = "ILike";
pub const QB_OP_IN: &str = "In";
pub const QB_OP_NOT_IN: &str = "NotIn";
pub const QB_OP_BETWEEN: &str = "Between";
pub const QB_OP_IS_NULL: &str = "IsNull";
pub const QB_OP_IS_NOT_NULL: &str = "IsNotNull";

/// Aggregate function identifiers used inside .aggregate({ ... }).
pub const QB_AGG_COUNT: &str = "Count";
pub const QB_AGG_SUM: &str = "Sum";
pub const QB_AGG_AVG: &str = "Avg";
pub const QB_AGG_MIN: &str = "Min";
pub const QB_AGG_MAX: &str = "Max";

/// Sort direction identifiers used inside .orderBy({}) clauses.
pub const QB_SORT_ASC: &str = "Asc";
pub const QB_SORT_DESC: &str = "Desc";

/// Check if a name is a QB comparison operator or sort direction (compile-time identifier).
#[inline]
pub fn is_query_operator(name: &str) -> bool {
    matches!(
        name,
        "Gt" | "Gte"
            | "Lt"
...
/// Check if a method name is a QB terminal.
#[inline]
pub fn is_query_terminal(method: &str) -> bool {
    matches!(method, "exec" | "execOne" | "toSql")
}

/// Check if a method name is a QB entry point (starts a chain on Database).
#[inline]
pub fn is_query_entry(method: &str) -> bool {
    matches!(
        method,
        "find" | "findOne" | "count" | "insert" | "insertMany" | "update" | "delete"
    )
}
