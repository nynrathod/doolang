//! Command implementations for init, deploy, and upgrade

use crate::templates::{self, TEMPLATES};
use crate::analytics;
use dialoguer::{theme::{ColorfulTheme, SimpleTheme}, Confirm, MultiSelect, Password, Select};
use std::{env, fs, io::{self, Write}, path::{Path, PathBuf}, process::{Command, Stdio}};
...
const ARROW_UP: &str = "  ";
const INFO: &str = "  ";
pub fn run_init(name_arg: Option<String>, template_arg: Option<String>) -> i32 {
...
pub fn run_deploy(verbose: bool) -> i32 {
    println!();
    println!("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━");
    println!("  🚀 Doo Deploy");
    println!("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━");
